  ...
  <q-layout view="lHh Lpr lFf" class="bg-grey-6">
    <q-header v-if="$route.meta.requireHeader" class="bg-brown-8">
      <q-toolbar class="q-py-xs">
        ...
        <q-toolbar-title>
          <!-- :width="$q.platform.is.desktop ? '100px' : '100px'"
          :height="$q.platform.is.desktop ? '100px' : '50px'" -->
          <q-img
            src="~/assets/logo-putri-duyung-depok.jpg"
            style="max-width: 50px; max-height: 50px"
            :ratio="1"
            :fit="$q.platform.is.desktop ? 'fill' : 'contain'"
            spinner-color="primary"
            spinner-size="20px"
          />
          <q-chip
            class="transparent text-white text-weight-bolder"
            label="Putri Duyung WaterBoom"
          />
        </q-toolbar-title>
